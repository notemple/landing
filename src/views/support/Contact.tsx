    ...
    <div className="space-y-12">
      ...
      <div className="pb-16 pt-4 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto space-y-8 text-left">
        <div className="space-y-4 font-sans text-sm text-zinc-600 leading-relaxed">
          <h2 className="font-heading font-semibold text-lg text-zinc-900">Get in Touch</h2>
          ...
          <div className="border border-zinc-200 rounded p-6 bg-white space-y-4">
            <div className="space-y-1">
              ...
              <p className="text-zinc-900 font-medium">support@templnote.com</p>
            </div>
            <div className="space-y-1">
          ...
          <h2 className="font-heading font-semibold text-lg text-zinc-900">Bug Reports</h2>
          <p>If you've found a bug, please include steps to reproduce, your browser, and any relevant screenshots when contacting us.</p>

          <h2 className="font-heading font-semibold text-lg text-zinc-900">Feature Requests</h2>
          <p>We love hearing ideas from our users. Reach out with any suggestions for how we can improve templnote.</p>
        </div>
      </div>
    </div>
  );
