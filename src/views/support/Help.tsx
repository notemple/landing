    ...
    <div className="space-y-12">
      ...
      <div className="pb-16 pt-4 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto space-y-8 text-left">
        <div className="space-y-4 font-sans text-base text-zinc-600 leading-relaxed">
          <h2 className="font-heading font-semibold text-xl text-zinc-900">Getting Started</h2>
          <p>Create an account, set up your first workspace, and start writing. templ is designed to be intuitive from the moment you open it.</p>

          <h2 className="font-heading font-semibold text-xl text-zinc-900">Keyboard Shortcuts</h2>
          ...
          <h2 className="font-heading font-semibold text-xl text-zinc-900">Managing Collections</h2>
          <p>Organize your notes into collections with custom tags and statuses. Use the grid view to sort and filter your content.</p>

          <h2 className="font-heading font-semibold text-xl text-zinc-900">AI Features</h2>
          ...
          <h2 className="font-heading font-semibold text-xl text-zinc-900">Daily Notes</h2>
