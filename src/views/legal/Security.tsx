...
export default function Security() {
  return (
    <div className="space-y-12">
      <PageHero
        title={<>Security</>}
        description="Learn about how we protect your data and the measures we take to keep templnote secure."
      />
      <div className="pb-16 pt-4 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto space-y-8 text-left">
        <div className="space-y-4 font-sans text-sm text-zinc-600 leading-relaxed">
          <h2 className="font-heading font-semibold text-lg text-zinc-900">Encryption</h2>
          ...
          <h2 className="font-heading font-semibold text-lg text-zinc-900">Infrastructure</h2>
          ...
          <h2 className="font-heading font-semibold text-lg text-zinc-900">Access Controls</h2>
          ...
          <h2 className="font-heading font-semibold text-lg text-zinc-900">Incident Response</h2>
          ...
          <h2 className="font-heading font-semibold text-lg text-zinc-900">Reporting Vulnerabilities</h2>
          <p>If you discover a security vulnerability, please report it responsibly by contacting our security team. We appreciate your help in keeping templnote safe.</p>
        </div>
      </div>
    </div>
  );
